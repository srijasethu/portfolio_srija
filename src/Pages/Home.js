                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Srija Sethu</b>
                          <b className="is-hidden">Data analyst</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/srijasethu?ref=https://srijasethu.github.io"
                              target="newtab"
                            >
                              <i
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        I'm Srija, a full stack developer and data analyst,
                        focused on building powerful digital experiences and
                        extracting insights that matter.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".1s">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I pay close attention to both design and logic, ensuring
                        every project looks clean and works smoothly.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".3s">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I enjoy breaking down complex challenges and finding
                        efficient, practical solutions through code and data.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".2s">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I’m always exploring new tools, frameworks, and concepts
                        to strengthen my skills in full-stack development and
                        data analysis.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".4s">
                      ...
                      <div className="underline2"></div>
                      <p>
                        I take responsibility seriously and deliver work with
                        dedication, consistency, and a strong work ethic.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      ...
                      <p className="wow fadeIn">
                        ...
                        <br />
                        <br />I also take pride in creating this website.
                      </p>
                      <a
                    ...
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            href="https://nagarcoil.kvs.ac.in/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            KVS,Nagercoil( PM SHRI Kendriya vidhyalaya)
                          </a>
                          in konam,Nagercoil, Tamilnadu, India.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            ...
                            rel="noopener noreferrer"
                          >
                            KSRCE (K.S.Rangasamy College of Engineering)
                          </a>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".4s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          I have successfully completed my diplamo in python
                          programming at CSE Academy, Nagercoil, India.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row love-row wow fadeIn">
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      <div className="service-head">
                        <img
                          src="assets/img/service/website-audit.jpeg"
                          alt="website-audit"
                        />
                      </div>
                      <div className="service-bottom">
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “Srija was a real pleasure to work with
                                      and we look forward to working with him
                                      again. she's definitely the kind of
                                      developer you can trust with a project
                                      from start to finish.”
                                      <br />
                                      <span>Sree Prathaa</span>
                                    </p>
                                  </blockquote>
                                </div>
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Srija is a clear communicator with the
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-4 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:dev.sethusrija@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
